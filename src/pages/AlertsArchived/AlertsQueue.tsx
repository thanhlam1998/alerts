...
const AlertsQueue = () => {
  ...
  const { data: alertQueue, isLoading: alertQueueLoading } = useQuery(["alertArchived"], getAlertQueue, {
    enabled: false,
  ...
  return (
    <PageWrapper
      ...
      breadcrumbItems={[
        ...
        {
          href: "#",
          title: t("Alerts Archived"),
        },
      ]}>
      <WrapperSection title={t("Alerts Archived")} headerClassName="!mb-0 pl-2" className="mb-4" />
      <WrapperSection title={t("Alerts Archived")} className="!p-4" loading={alertQueueLoading}>
